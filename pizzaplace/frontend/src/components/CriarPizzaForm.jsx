...
const CriarPizzaForm = () => {
  ...
  const gerirMudancaImagem = (e) => {
    ...
    if(ficheiro)
    {
        ...
        leitor.readAsDataURL(ficheiro); //Conversão para formato Base64 
    }
  };
                ...
                <form onSubmit={gerirSubmissao} className="space-y-4">
                    ...
                    <div className="mt-1 flex items-center">
                        ...
                        leading-4 font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
                            <Upload className="h-5 2-5 inline-block mr-2" />Escolher Imagem
                        </label>
                        ...
                        className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm
                            ...
                            disabled={loading}>
                                {loading ? (
                                    ...
                                    <>
                                        <PlusCircle className="mr-2 h-5 2-5"/>
                                        Criar Produto
                                    </>
                                )}
                    </button>
