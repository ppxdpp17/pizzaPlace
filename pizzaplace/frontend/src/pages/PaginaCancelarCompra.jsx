        ...
        <motion.div 
            ...
            className="max-w-md w-full bg-gray-800 rounded-lg shadow-xl overflow-hidden relative z-10">
                <div className="p-6 sm:p-8">
                    ...
                    <p className="text-gray-300 text-center mb-6">O seeu pedido foi cancelado. Nenhum valor foi cobrado.</p>
                    <div className="bg-gray-700 rounded-lg p-4 mb-6">
                        <p className="text-sm text-gray-400 text-center">
                            Se encontrou algum erro durante o processo de checkout, por favor não hesite em contactar com a nossa equipa de supoert
                        </p>
                    </div>
                    <div className="space-y-4">
                        <Link to={"/"}
                            className="w-full bg-gray-700 hover:bg-gray-600 text-gray-300 font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center">
                                <ArrowLeft className="mr-2" size={18}/>Voltar à loja
                        </Link>
                    </div>
                </div>
        </motion.div>
...
export default PaginaCancelarCompra